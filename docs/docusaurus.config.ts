...
const config: Config = {
  title: 'Sound-Manaer',
  tagline: 'A sound management Library',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/dev-lukas0/Sound-Manager/tree/master/docs',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/dev-lukas0/Sound-Manager',
          label: 'GitHub',
          position: 'right',
        },
      ],
